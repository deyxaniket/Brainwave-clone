    ...
    <div className="container flex gap-[1rem] max-lg:flex-wrap">
      {pricing.map((item) => (
        ...
        >
          ...
          <Button className="w-full mb-6" white={!!item.id == 2}>
            Get Started
          </Button>
          <ul>
